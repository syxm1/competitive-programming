/*
    ...
    - the MEX of the subarray is equal to the MEX of the whole array.
    - iterate through the array and stop immediately when the MEX of the current subarray is equal to the MEX of the whole array.
*/
...
void solve(int tc) {
    ...
    vector<int> a(n), exist(n+2, 0);
    for(int &i : a) {cin >> i; exist[i] = 1;}
