...
void solve(int tc) {
    /*
    sort the array and take unique elements only.
    the answer is equal to the longest consecutive subarray with the difference between rightmost and leftmost elements < n.
    i.e. all of the elements in that subarray can become the same.
    */
    int n;
    cin >> n;
    vector<int> a(n);
