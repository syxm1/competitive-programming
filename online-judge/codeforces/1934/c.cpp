/*
    ...
    define d1 as the index of '/' diagonal (x + y - 1) and d2 as the index of '\' diagonal (x - y).

    steps to find a mine:
    -    ask for (1, 1) query to get d1 of the mine.
    -    save the d1 and get the d2 from the corner of d1 we've got.
    -    get the intersection point of d1 and d2 to be the candidate.
    -    query for the intersection point, if the distance is 0, then it is the answer.
    -    otherwise, query another corner from d1 and get the intersection point. this intersection point
